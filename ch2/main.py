...
if __name__ == '__main__':
    ...
    e: list[int] = tokenizer.encode_to_file(content, Path("tokenized_tiny_story"))
    token_ids_path = "/Users/liyuheng/Documents/cs336/cs336-assignment1-basics/data/tinystories_token_ids.npy"
    Tokenizer.save_encoded_ids(e, token_ids_path)
    e_np = Tokenizer.load_encoded_ids(token_ids_path, mmap_mode="r")

    t2 = perf_counter()

    print(len(e))
    print(e_np.shape, e_np.dtype)
